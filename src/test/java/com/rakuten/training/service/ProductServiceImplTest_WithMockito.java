...
public class ProductServiceImplTest_WithMockito {
...
//	    Product returnedByMock = new Product("test",1000f,1);
...
//	}
	...
	@Test
	public void removeExisting_Must_Call_DeleteById_When_Product_Value_LT_100k() {
		//AAA
		//Arrange
		ProductServiceImpl objUnderTest = new ProductServiceImpl();
		int idToTest = 1;
